...
contract Bounties {
  ...
  */
      ...
      returns (uint)
  {
      ...
      BountyIssued(bounties.length - 1,msg.sender, msg.value, _data);
  ...
  */
    ...
    isBeforeDeadline(_bountyId)
  {
    ...
    BountyFulfilled(_bountyId, msg.sender, (fulfillments[_bountyId].length - 1),_data);
  }
  ...
  */
      ...
      fulfillmentNotYetAccepted(_bountyId, _fulfillmentId)
  {
      ...
      FulfillmentAccepted(_bountyId, bounties[_bountyId].issuer, fulfillments[_bountyId][_fulfillmentId].fulfiller, _fulfillmentId, bounties[_bountyId].amount);
  }
  ...
  */
      ...
      hasStatus(_bountyId, BountyStatus.CREATED)
  {
      ...
      BountyCancelled(_bountyId, msg.sender, bounties[_bountyId].amount);
  }
